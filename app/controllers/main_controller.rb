class MainController < ApplicationController
  def index
    ...
    @sidebar_item_1_2 = "Rubriques"
    @sidebar_item_1_2_icon_1 = "bi-menu-button-wide-fill"
    @sidebar_item_1_2_visibility = ""
    @sidebar_item_1_2_link = root_path

    @sidebar_item_1_3 = "Gest. du Personnel"
    @sidebar_item_1_3_icon_1 = "bi-people-fill"
    @sidebar_item_1_3_visibility = ""
    @sidebar_item_1_3_active = ""
    @sidebar_item_1_3_link = g_personnel_path

    @sidebar_item_1_4 = "Gest. des Dépenses"
    @sidebar_item_1_4_icon_1 = "bi-bank2"
    @sidebar_item_1_4_visibility = ""
    @sidebar_item_1_4_active = ""
    @sidebar_item_1_4_link = g_depense_path

    @sidebar_item_1_5 = "Gest. des Courriers"
    @sidebar_item_1_5_icon_1 = "bi-envelope-fill"
    @sidebar_item_1_5_visibility = ""
    @sidebar_item_1_5_active = ""
    @sidebar_item_1_5_link = g_courrier_path

    @sidebar_item_1_6 = "Gest. des Archives"
    @sidebar_item_1_6_icon_1 = "bi-archive-fill"
    @sidebar_item_1_6_visibility = ""
    @sidebar_item_1_6_active = ""
    @sidebar_item_1_6_link = g_archive_path

    @sidebar_item_1_7 = "Projets & Formations"
    @sidebar_item_1_7_icon_1 = "bi-pie-chart-fill"
    @sidebar_item_1_7_visibility = ""
    @sidebar_item_1_7_active = ""
    @sidebar_item_1_7_link = g_projet_path
    ...
    @banner_btn_5_1 = "Gest. du Personnel"
    @banner_btn_5_1_icon_1 = "bi-people"
    @banner_btn_5_1_visibility = ""
    @banner_btn_5_1_active = ""
    @banner_btn_5_1_link = root_path

    @banner_btn_5_2 = "Gest. des Dépenses"
    @banner_btn_5_2_icon_1 = "bi-bank"
    @banner_btn_5_2_visibility = ""
    @banner_btn_5_2_active = ""
    @banner_btn_5_2_link = root_path

    @banner_btn_5_3 = "Gest. des Courriers"
    @banner_btn_5_3_icon_1 = "bi-envelope"
    @banner_btn_5_3_visibility = ""
    @banner_btn_5_3_active = ""
    @banner_btn_5_3_link = root_path

    @banner_btn_5_4 = "Gest. des Archives"
    @banner_btn_5_4_icon_1 = "bi-archive"
    @banner_btn_5_4_visibility = ""
    @banner_btn_5_4_active = ""
    @banner_btn_5_4_link = root_path

    @banner_btn_5_5 = "Projets & Formations"
    @banner_btn_5_5_icon_1 = "bi-pie-chart"
    @banner_btn_5_5_visibility = ""
